...
export class HomeComponent implements OnInit {
  ...
  constructor(
    ...
    this.communication.onScrollTo$.subscribe((section: number) => {
  ...
  ngOnInit() {
    // seo
    this.page.updateTitle(this.i18n.translate(this.globals.browserSetup, 'title'));
    this.page.updateDescription(this.i18n.translate(this.globals.browserSetup, 'description'));
    ...
    // initialize home component -> use stored data
    if (home.loaded && general.loaded && features.loaded) {
      ...
      console.warn('Error: ', [{ home: home.loaded }, { general: general.loaded }, { features: features.loaded }]);
    }
  }
